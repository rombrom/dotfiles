...
# Keep “natural” (Lion-style) scrolling
...
# Spring load after 100ms
defaults write NSGlobalDomain com.apple.springing.delay -float 100
...
tell application "Terminal"
	...
	do shell script "open '$HOME/.mac-setup/" & themeName & ".terminal'"
